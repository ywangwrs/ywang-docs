...
::-webkit-scrollbar-track { box-shadow: rgba(0,0,0,0.3) 0px 0px 0px inset; border-radius: 3px; }
::-webkit-scrollbar-thumb { border-radius: 3px; box-shadow: rgba(0,0,0,0.5) 0px 0px 6px inset; background: rgb(0,255,0);
